    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject1_code', models.CharField(blank=True, max_length=255, null=True)),
                ('subject2_code', models.CharField(blank=True, max_length=255, null=True)),
                ('subject3_code', models.CharField(blank=True, max_length=255, null=True)),
